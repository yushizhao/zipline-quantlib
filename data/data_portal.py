...
BASE_FIELDS = frozenset([
    'adjusted_close', 'ask', 'bid', 'close', "volume", "price", "last_traded", "open_interest"
])

OHLCV_FIELDS = frozenset([
    'adjusted_close', 'ask', 'bid', 'close', "volume"
])

OHLCVP_FIELDS = frozenset([
    'adjusted_close', 'ask', 'bid', 'close', "volume", "price"
])
...
class DataPortal(object):
    ...
    def _get_daily_data(self, asset, column, dt):
        ...
        if column == "last_traded":
            ...
            val = reader.get_value(asset, dt, "open_interest")
            return val
