...
def load_yahoo_csv(filepath, identifier_col):
...
def yahoo_CSV(symbols, start=None, end=None):
    ...
    def ingest(environ,
        ...
        # asset_map = {0 : r"/mnt/hgfs/595P/project_Z/tests/resources/yahoo-test.csv"}
        # daily_bar_writer.write_csvs(asset_map, show_progress=show_progress)
