...
""".strip().format(class_name=self.__class__.__name__,
    ...
    @api_method
    def get_asset_info(self, asset, field):
        """Yuusha note: Query asset information.
        """
        return getattr(asset,field)

    @api_method
    def set_expiration(self, asset, date):
        """Yuusha note: In order to realize early exercise. 
        Set the expiration back, if we want to hold that asset again.
        """
        setattr(asset,"expiration", date)
